...
function Contact() {
  ...
  return (
    <div>
      ...
      <form ref={form} className='flex flex-col bg-gradient-to-t from-purpleNeon to-navy rounded-lg w-1/2 m-0 p-10 mx-auto shadow-md text-primary' onSubmit={sendEmail}>
        ...
        <textarea className='bg-navy p-4 focus:shadow-skillCard rounded-xl mb-4' name="message" placeholder='Message' required id="" cols="10" rows="10"></textarea>
