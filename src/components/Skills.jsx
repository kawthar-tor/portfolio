  ...
  return (
    <div>
      ...
      {professionalTitles.map((professionalCard, index) => (
        <div key={index} style={{backgroundImage: `url(${professionalCard.bg})`,backgroundSize: 'cover'}} className='shadow-skillCard flex items-center text-center justify-center h-64 w-1/3 md:w-1/5 rounded-lg'>
      ...
      <section className='my-20'>
        ...
        {technologies.map(technology => (
          <div className='bg-navy relative w-1/4 md:w-1/6 rounded-lg p-2'>
